...
insert into PG560_JEE_TECHNOLOGY(acronyms, version, jsr, description) values( 'DI', '1.0', '330', 'Dependency Injection for Java 1.0.');
insert into PG560_JEE_TECHNOLOGY(acronyms, version, jsr, description) values( 'JDBC', '4.0', '221', 'The Java Database Connectivity (JDBC) API is the industry standard for database-independent connectivity between the Java programming language and a wide range of databases  SQL databases and other tabular data sources, such as spreadsheets or flat files.');
insert into PG560_JEE_TECHNOLOGY(acronyms, version, jsr, description) values( 'JMX', '2.0', '255', 'The JMX technology provides the tools for building distributed, Web-based, modular and dynamic solutions for managing and monitoring devices, applications, and service-driven networks.');
insert into PG560_JEE_TECHNOLOGY(acronyms, version, jsr, description) values( 'JAXP', '1.3', '206', 'The Java API for XML Processing (JAXP) enables applications to parse, transform, validate and query XML documents using an API that is independent of a particular XML processor implementation.');
